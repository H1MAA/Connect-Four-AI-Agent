...
def minimax(board_str, depth, maximizingPlayer):
    ...
    if maximizingPlayer:
        ...
        for col in valid_moves:
            ...
            new_score = minimax(array_to_string(temp_board), depth - 1, False)[1]
        ...
        for col in valid_moves:
            ...
            new_score = minimax(array_to_string(temp_board), depth - 1, True)[1]
            if new_score is not None and new_score < value:
                value = new_score
                best_col = col
        return best_col, value
